 <div id="inner-pg-container" class="container-fluid p-0 rounded shadow">
     <div class="row h-100" id="inner-pg-content">
         <div class="container">
             <!-- Slider Options  -->
             <div class="row">
                 <div class="container home setting-pannel">

                     <div class="box3 shadow box mx-5 active" data-box-id="upload-cont"
                         onclick="relevant_Container(this)"><span class="iconify"
                             data-icon="entypo:folder-video"></span>
                         <h6>Media</h6>
                     </div>
                     <div class="box2 shadow box" data-box-id="content-cont" onclick="relevant_Container(this)"><span
                             class="iconify" data-icon="clarity:picture-solid"></span>
                         <h6>Content</h6>
                     </div>
                 </div>
             </div>
                             ...
                             <div
                                 ...
                                 <div class="upload-box rounded d-flex justify-content-center align-items-center">
                                     <label for="input-video">
                                         <span class="iconify" data-icon="gridicons:cloud-upload"
                                             style="color: black;"></span>
                                     </label>
                                     <input type="file" name="" id="input-video" data-container="#imgContainer"
                                         class=" d-none" onchange="readURL(this)">
                                 </div>
                             </div>
